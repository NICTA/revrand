...
%% Terms/Acronyms
\newcommand{\revrand}   {\emph{revrand}}
...
\newcommand{\inssprime} {\ensuremath{\inss'}}
...
\newcommand{\featsym}   {\ensuremath{\phi}}
\newcommand{\featfunc}[1]  {\ensuremath{\featsym\!\brac{#1}}}
\newcommand{\singlefeatfunc}[2]  {\ensuremath{\phi_{#2}\!\brac{{#1}}}}
\newcommand{\weights}   {\ensuremath{\mathbf{w}}}
\newcommand{\var}       {\ensuremath{\sigma^2}}
\newcommand{\lenscale}  {\l_{\featsym}}
...
\newcommand{\Reg}       {\ensuremath{\boldsymbol{\Lambda}}}
...
\newcommand{\cdfAlph}   {\ensuremath{\alpha}}
\newcommand{\resamp}    {\ensuremath{\boldsymbol\epsilon}}
...
% Fourier things
\newcommand{\tfourier}{\boldsymbol{\tau}}   % time space
\newcommand{\ffourier}{\boldsymbol{\omega}} % freq space
\newcommand{\specfourier}{p_{\ffourier}}
...
\newcommand{\KL}[2]      {\ensuremath{\text{KL}\!\left[{#1}\middle\|
                          {#2}\right]}}
