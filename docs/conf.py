...
project = u'revrand'
copyright = "2015, Daniel Steinberg, Louis Tiao, Lachlan McCalman, " \
    "Alistair Reid, Simon O'Callaghan"
...
latex_documents = [
  (master_doc, 'revrand.tex', 'revrand Documentation',
   "Daniel Steinberg, Louis Tiao, Lachlan McCalman, Alistair Reid, Simon "
   "O'Callaghan", 'manual'),
]
